...
// be ignored when creating the hash. To avoid any confusion for
// users, we’ll simply enforce a hard maximum length of 72 bytes
// on the password in our validation checks. If you don’t want to
// enforce a maximum length, you could pre-hash the password instead.
